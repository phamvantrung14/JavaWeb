            ...
            <div class="col-lg-3 col-md-12">
                ...
                <aside class="sidebar_widget">
                    <div class="widget_list widget_categories">
                        ...
                        <ul>
                            <c:forEach items="${cateDM}" var="cateDM">
                                <li><a href="productCategories.htm?cateId=${cateDM.catId}&&page=1">${cateDM.catName}</a></li>
                                </c:forEach>
            ...
            <div class="col-lg-9 col-md-12">
                ...
                <div class="shop_toolbar_wrapper">
                    ...
                    <div class="page_amount">
                        <p><p>Tổng: ${lisPro.size()} sản phẩm</p></p>
                    </div>
                </div>
                <!--shop toolbar end-->
                ...
                <div class="row no-gutters shop_wrapper grid_4">
                    <c:forEach items="${lisPro}" var="product">                         
                        ...
                        <ul>
                            <c:if test="${paginateInfo.totalPage>1}">
                                ...
                                <c:forEach var="gift" begin="1" end="${paginateInfo.totalPage}" varStatus="loop">
                                    ...
                                    <li class="current"><a  href="<c:url value="productCategories.htm?cateId=${cateId}&&page=${loop.index}"/>">${loop.index}</a></li>
                                    </c:if>
                                    <c:if test="${(loop.index)!=paginateInfo.currentPage}">
                                    <li class=""><a class="" href="<c:url value="productCategories.htm?cateId=${cateId}&&page=${loop.index}"/>">${loop.index}</a></li>
                                    </c:if>
                                </c:forEach>
                                <c:if test="${paginateInfo.totalPage>1}">
